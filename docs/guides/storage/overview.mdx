...
<CardGroup cols={3}>
  ...
  <Card title="Redis Adapter" icon="database" href="/guides/storage/redis-adapter">
    Multi-pod environments
  </Card>
  <Card title="Memory Adapter" icon="memory" href="/guides/storage/memory-adapter">
...
<CardGroup cols={2}>
  <Card title="Cache Invalidation" icon="rotate" href="/guides/storage/cache-invalidation">
