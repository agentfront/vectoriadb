...
<Update label="v2.0.x" description="December 2025 - January 2026" tags={["Releases"]}>
  ...
  <Card
    title="VectoriaDB v2.0.0: Optional transformers and lazy loading"
    href="https://github.com/agentfront/vectoriadb/releases/tag/v2.0.0"
    cta="View full changelog"
  >
    **Optional Peer Dependencies** – `@huggingface/transformers` is now optional, enabling smaller bundle sizes when using TF-IDF only.
